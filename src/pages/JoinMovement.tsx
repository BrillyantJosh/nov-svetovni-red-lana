          ...
          <section id="globoka-agenda" className="mt-16 pt-12 border-t border-border">
            <div className="text-center">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <p className="text-lg text-foreground leading-relaxed mb-6">Ampak hej… vzemi si ga/jo raje dobr "v roke", poglej jo globoko v oči in pusti, da ti misli malo spolzijo dol med noge, namesto da ti tičijo v glavi 😏💦</p>
                <p className="text-lg text-foreground leading-relaxed">Naj te luna rajca, naj ti malo zmeša um in naj se zgodi orgazem, ki vse preplete in razplete hkrati. Ker včasih je edina prava agenda — da se 'maš fajn 🔥✨</p>
              </div>
            </div>
          </section>
        </div>
