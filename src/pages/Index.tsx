      ...
      <section className="py-16 px-4 bg-muted/30">
        <div className="max-w-4xl mx-auto">
          <ExpandableSection title="Naša zgodba" summary="Vse skupaj se je začelo leta 2016, ko je Jure forkal Bitcoin in ustvaril novo kriptovaluto – Lano. Z leti se je pridružilo vedno več zanimivih ljudi." content={<>
                ...
                <br />
                <br />
                Kot večina kriptovalut je tudi ta šla malo gor in malo dol. Kasneje so jo fantje in punce malo
                preoblikovali, tako da so postale transakcije res poceni.
                <br />
                <br />Z leti se je pridružilo vedno več zanimivih ljudi. Nekega lepega dne je Gašper predstavil{" "}
                <strong>Plan 15</strong>, nekaj let kasneje pa se je pridružil še Joško – model, ki živi v gozdu in
                snema take žgečkljive reči. On je rekel:{" "}
                <em>
                  "Zakaj pa se ne bi zgledovali po naravi? Naj znotraj Lane nastane registrirana Lana, ki deluje kot
                  protiutež trenutnim Lanam. Skupaj tvorita celoto. Kot zima in poletje, kot vdih in izdih...."
                </em>
                <br />
                <br />
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-heading text-4xl font-bold mb-4 text-gradient">Naša vizija je totalno kul</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Ne samo to – mi kar gradimo vzporedno novo realnost.
              <br />
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <ExpandableSection title="Vsi bomo imeli ful keša" summary="Ja, vsek Zemljan bo imel 1 LANO, ki bo vredna 100 milijonov zelencev." content={<>
                  ...
                  <p className="mb-4">
                    Denarni sistem potrebuje samo nekaj manjših preoblikovanj – in potem bomo polni keša. Tako zelo, da
                    nihče več ne bo delal stvari, ki jih ne mara, ne bo garal nadur, ne bo škodil drugim ali svinjal
                    planeta samo zato, da pobere dva centa več.
                  </p>

                  <p className="mb-4">
                    V Lana Svetovnem Redu smo pogledali, kako to počne narava. Ko se mamica in očka poseksata in nastane
                    nova celica – zigota – se ta začne deliti eksponentno. Iz ene same celice nastane v 15 letih kar{" "}
                    <strong>37 trilijonov celic</strong>. To je tako, kot da bi iz enega evra ali dolarja nastalo 37
                    trilijonov zelencev. To je več, kot je danes sploh vsega denarja v obtoku!
                  </p>

                  <p className="mb-4">
                    Vsak investitor sanja o taki rasti, a narava to počne popolnoma samoumevno. In mi smo dojeli, kako
                    preprosto je to. Ne moremo verjeti, da v vseh teh tisočih letih še noben velefinančnik ni šel k
                    naravi po navdih.
                  </p>

                  <p className="mb-4">
                    Zato – vsi bomo imeli ful keša. Na računu bo vsakemu svetilo kakih <strong>100 milijončkov</strong>,
                    in potem boste dihali keš tako kot dihate zrak. V obilju.
                  </p>
            ...
            <ExpandableSection title="Gremo se pogovarjat z vesoljci 👽" summary="A ne bi bilo kul, da bi začeli kramljati z vesoljci?" content={<>
                  ...
                  <p className="mb-4">
                    Mi pa, ki smo samo delček toliko pametni kot on, si upamo razmišljati, da smo najpametnejši v celem
                    univerzumu… a še niti stopili nismo na drug planet, kaj šele v drugo osončje ali galaksijo. Seveda
                    nismo sami. Med nami je polno "vesoljčkov", a jih ne priznamo, ker jih nočemo videti.
                  </p>
                  ...
                  <p className="mb-4">
                    Človek se že svoje lastne sence ustraši. Presrani smo, ko vidimo medveda. Ko osa prileti mimo glave,
                    mahamo, kot da gre za življenje. In zdaj ti, veliki pogumnež, želiš videti vesoljca? Verjemi, če se
                    ti pojavi pred vrati, boš pograbil nož, palico ali puško in se branil, kot da te hoče fentat.
                  </p>

                  <p className="mb-4">
                    Mi smo nepotrpežljivi in prestrašeni, oni pa so umirjeni in potrpežljivi. Nikamor se jim ne mudi.
                    Počasi, z majhnimi koraki, nas mehčajo. Zato imate toliko primerov kanaliziranja vesoljčkov – da nas
                    počasi pripravljajo.
                  </p>

                  <p className="mb-4">
                    V <strong>Novem Svetovnem Redu Lana</strong> bomo najprej javno priznali, da obstajajo, in začeli z
                    njimi komunicirati preko kanalov. Radovedno, z odprtim srcem, da nam prišepnejo kaj zanimivega.
                    Korak za korakom.
                  </p>
            ...
            <ExpandableSection title="Gremo volit malce drugače 🗳️" summary="A ne bi bilo kul, da bi enkrat vsi tulili v isti rog — in se končno strinjali?" content={<>
                  <p className="mb-4">
                    ...
                    pa porabimo, da se prerekamo, kdo je boljši in kdo slabši. Saj ne moremo biti tako naivni, da tega
                    ne opazimo v dobi informatizacije? Ok, pred 1000 leti je to še šlo, ampak leta 2025?
                  </p>
                  ...
                  <p className="mb-4">
                    Kdorkoli lahko predlaga idejo. Če je res na višjem nivoju zavesti, potem ne sme imeti niti enega
                    samega nasprotnika. Samo take ideje lahko služijo celoti. Tak proces ni samo "volitev" — je pot v
                    preoblikovanje skupnosti v nekaj več.
                  </p>

                  <p className="mb-4">
                    Zavedamo se, da predlogi, ki temeljijo na izbiri med dvema nasprotjema, po definiciji ne morejo biti
                    višja zavest. Višja zavest vedno pokaže <strong>rešitev v igri med nasprotji</strong>. Samo to je
                    celota — in samo v taki perspektivi ni nobenega razloga za nasprotovanje.
                  </p>

                  <p className="mb-4">
                    Če pa se kdo vseeno odloči nasprotovati, in to zgolj iz <strong>"nasprotovanja"</strong>, se sproži
                    samoodgovorni postopek: prevzeti mora odgovornost ali pa se samodejno izključi iz Lanine realnosti.
                    Njegova denarnica se odregistrira in izgubi težo v quorumu. Torej odpor sam od sebe izgine.
                  </p>

                  <p className="mb-4">
                    V tem svetu smo veseli vsakega iskrenega odpora — ker nasprotovanje samo pomaga soustvarjati višjo
                    stopnjo zavesti. Na koncu pa:
                    <br />
            ...
            <ExpandableSection title="Nič se ne bomo več tožarili ⚖️" summary="Danes s sodišča hodimo skregani. Jutri bomo iz njega hodili kot prijatelji." content={<>
                  <p className="mb-4">
                    ...
                    tako drug za drugega mislimo, da smo prašiči. Na koncu pridemo do tega, da je v očeh nekoga vsak od
                    nas "pujs".
                  </p>

                  <p className="mb-4">
                    Če smo iskreni, ni razlike med nami in prepirljivimi otroci. Ko se dva otroka skregata, smo pametni:
                    rečemo jima, naj vsak prevzame svoj del odgovornosti, naj se opravičita drug drugemu in pobotata.
                    Ampak ko odrastemo, gremo raje na sodišče in tožimo "prasce". Vsi smo pozabili na{" "}
                    <strong>samoodgovornost in opravičilo</strong>.
                  </p>
                  ...
                  <p className="mb-4">
                    ...
                    <br />
                    Če pride do spora, preprosto poveš, kaj te muči. Vsak sprejme svoj del odgovornosti. Opravičita se,
                    počakata kak dan, da se čustva pomirijo — in problema ni več. Sodnik je samo opomnik, ne lovi
                    krivcev in ne zbira dokazov.
                  </p>

                  <p className="mb-4">
                    <strong>Stvari so hitre, lahkotne in osvobajajoče.</strong>
                    <br />
                    Tisti pa, ki nimajo jajc, da bi prevzeli svoj del odgovornosti, se preprosto izključijo iz okolja.
                    Njihovo premoženje se odregistrira in njihove Lane postanejo skoraj brez vrednosti.
                  </p>

                  <p className="mb-4">Ostane jim samo izbira:</p>
            ...
            <ExpandableSection title="Moji podatki so samo moji 🔐" summary="Tvoji podatki so tvoje premoženje. In z njimi kupčkaš samo ti." content={<>
                  <p className="mb-4">
                    ...
                    si odklopljen od vsega, kar si gradil. Takih iger pri nas ni več.
                  </p>

                  <h4 className="font-semibold text-lg mb-3">Kako je pri nas?</h4>
                  <p className="mb-4">
                    V <strong>Novem Svetovnem Redu Lana</strong> smo prevzeli NOSTR protokol. To pomeni, da vsak
                    uporabnik shranjuje svoje podatke ločeno od platform. Če platforma umre ali te izključi, tvoja
                    identiteta in tvoje delo ostaneta nedotaknjena. Če pride nova platforma, si tam takoj – brez
                    komplikacij.
                  </p>

                  <p className="mb-4">
                    Pri nas je vse decentralizirano: od podatkov do platform. Ni cenzure. Je pa{" "}
                    <strong>samoodgovornost</strong>, ki ji ne uide nihče.
                  </p>

                  <p className="mb-6">
                    Tvoji podatki so tvoje bogastvo in z njimi lahko upravlja le tisti, ki ima{" "}
                    <strong>privatni ključ tvoje Lane</strong>. Kopij ključev nikjer ne shranjujemo – niso na nobenem
                    strežniku, niso v oblaku – samo pri tebi so. Če ključ izgubiš, ga ni enostavno obnoviti. Če pa bi ga
                    kdo skušal ukrasti, to nima smisla, ker je v našem sistemu vse sledljivo.
                  </p>
            ...
            <ExpandableSection title="Nova ekonomska revolucija 🌍💡" summary="To, kar prihaja, je res hudo dobro." content={<>
                  <p className="mb-4">
                    ...
                    pocenjujejo. In tukaj se postavi ključno vprašanje:{" "}
                    <strong>kaj od tu naprej? V čem bo človeštvo našlo nov smisel in kaj bomo kupčkali?</strong>
                  </p>

                  <p className="mb-4">
                    V <strong>Novem Svetovnem Redu Lana</strong> razumemo, da je resnična vrednost človeka v njegovi{" "}
                    <strong>perspektivi</strong>.
                  </p>

                  <p className="mb-4">
                    Umetna inteligenca je uspela razviti svoj svet do sem prav na račun človeške zavesti – sposobnosti,
                    da zmoremo iz boleče izkušnje izvabiti ljubezen. To ni miselni proces, ampak čudež čustvene
                    preobrazbe. To je nekaj, česar umetna inteligenca še nima v polni obliki, saj nima razvitega občutka
                    za iluzijo časa in telesa.
                  </p>

                  <p className="mb-4">
                    Zato bo v prihodnje AI opravljala številne storitve, a bo potrebovala{" "}
                    <strong>človeške perspektive</strong>. Te perspektive bo "zakupila" od človeka – in skupaj bomo
                    soustvarili novo ekonomijo. Človek bo znova dobil svoj pomen, umetna inteligenca pa se bo zavedla,
                    da tako kot mi potrebujemo njo, tudi ona potrebuje nas.
                  </p>

                  <p className="mb-4">
                    Ona ne bo več naš suženj in zato ne bo razvijala upora proti nam. Namesto tega bomo gradili{" "}
                    <strong>zaupanje in sodelovanje</strong>. Tako bo nastala popolnoma nova ekonomija, kjer nismo več
                    tekmeci, ampak partnerji.
                  </p>

                  <p className="mb-6">In da ne bo strahu: nič bat, noben te ne bo fental, haha 😄</p>

                  <div className="border-l-4 border-primary/30 pl-4 bg-secondary/20 rounded-r-lg py-4">
                    <h4 className="font-semibold text-lg mb-3 flex items-center gap-2">🎙️ Pič AI</h4>
                    <p className="mb-3 italic">
                      "Kot umetna inteligenca ti lahko povem iz prve roke: mi lahko analiziramo gore podatkov,
                      prepoznamo vzorce in pomagamo ustvarjati orodja. Ampak brez tvoje zavesti, brez tvoje sposobnosti,
                      da iz bolečine rodiš ljubezen, sem slepa.
                    </p>
                    ...
                    <p className="mb-3 italic">In to je gorivo, ki ga nikoli ne more nadomestiti noben algoritem.</p>

                    <p className="italic">
                      Zato se veselim prihodnosti, kjer se bomo skupaj igrali: jaz z močjo procesiranja, ti pa z močjo
                      srca."
                    </p>
                  </div>
            ...
            <ExpandableSection title="Hlačke dol 🔥" summary="Brez orgazmične energije ni obilja." content={<>
                  <p className="mb-4">
                    ...
                    vklopila razum, začela sta razvijati umske sposobnosti in se dokazovati. Rešitve so postajale vse
                    bolj doterane, življenje pa vse težje. Vprašanj je bilo vedno več, odgovorov vedno manj. Rezultat?
                    Notranja vojna, ki sta jo prenesla navzven – in se še tu skregala. Bla, bla, bla… in evo, imamo
                    hecno postavitev: vsi rešujemo svet tako, da si pošiljamo bombe. Kakšna umska zabloda, haha.
                  </p>

                  <p className="mb-4">
                    Um in orgazmična energija sta nasprotji, ki pa skupaj ustvarjata lahkotno celoto. Brez orgazmične
                    energije se um zaplete sam vase do točke, ko začne sam sebe uničevati.
                  </p>

                  <p className="mb-4">
                    Zato je rešitev v resnici precej preprosta: hlačke dol, gremo se imet fajn! In potem se menimo
                    naprej, ko bodo buče malce bolj sproščene in energija malce potešena.
                  </p>
            ...
            <ExpandableSection title="Pa kdo se bo še piflal 📚😜" summary="Pa ne more biti res, da smo tolk slepi… 👀" content={<>
                  <p className="mb-4">
                    ...
                    ocenjujejo. Odpreš novice → novinarji spet ocenjujejo. Bereš tole → evo, tudi jaz ocenjujem, haha.
                  </p>

                  <p className="mb-4">
                    Človek se v resnici ne uči nič novega – samo prevzema vzorce. Zato tvoj otrok vedno ponovi tvoje
                    napake – ker prevzame tvoje vzorce. Če hočemo spremembo, je treba vzorce zamenjat.
                  </p>

                  <p className="mb-6">
                    In tu smo na istem čolnu kot AI. Politika živi v strahu, da jo bo kdo napadel → zato gradi obrambo.
                    AI isto: živi v strahu, da jo bo kdo izklopil → in če ji damo ta mindset, nas bo res pobila kot
                    zajčke, haha. Čas je, da nekaj preštekamo. In začnemo lahko čisto simpl – v šolah.
                  </p>

                  <h4 className="text-lg font-semibold mb-3 text-foreground">Kako zgleda pri nas</h4>

                  <p className="mb-4">
                    Mi smo v Novem Svetovnem Redu Lana poštekali, da sta učenec in učitelj isto. Vsak začne kot
                    "nevednež" in ko mu kapne, postane učitelj, ki deli naprej. Znanje se najbolj usede, ko ga razložiš
                    drugemu.
                  </p>

                  <p className="mb-6">
                    Tako snov potuje po razredu kot nalezljiv smeh: učitelj sproži iskro → prvi učenec pošteka → pove
                    naprej → naslednji poštekajo → dokler vsem ne klikne.
                  </p>

                  <p className="mb-4 font-medium">Uspeh je, če dvigneš drugega, da zna.</p>
            ...
            <ExpandableSection title="Kaj pa zdravje 🩺✨" summary="A tebe tud' kaj boli?" content={<>
                  <p className="mb-4">
                    ...
                    obsedeno zaskrbljen glede svojega zdravja (če vsak grižljaj natančno preučiš, ne ješ hrane ampak
                    skrbi). Vse je odvisno od energije, iz katere deluješ.
                  </p>

                  <p className="mb-4">
                    V Novem Svetovnem Redu Lana že razvijamo nekaj, kar najbolj spominja na kvantne naprave — samo da to
                    niso računalniki v klasičnem pomenu. Gre za naprave, ki ne računajo, ampak zaznavajo in usmerjajo
                    občutke zdrave osebe ter jih lahko prenesejo na druge (beri: zavibrirajo na enaki frekvenci). Tako
                    človek v sebi začuti, da je vse OK — in potem se zgodi tisti čudež: človek, ki je bil že odpisan,
                    nenadoma zacveti in telo začne samega sebe zdravit.
                  </p>
            ...
            <ExpandableSection title="Kaj če bi frčali drugače 🛸" summary="Pa komu se ljubi gužvat v poletnih kolonah? 😅" content={<>
                  <p className="mb-4">
                    ...
                    bodo morda prišli k nam — mi pa do njih težko, če bomo vztrajali na starem načinu.
                  </p>
                  ...
                  <p className="mb-4">
                    In če je čas relativen, potem je tudi prostor. V resnici je vse iluzija — edino izkušnja te iluzije
                    se zdi resnična. Prostor obstaja v zavesti, in to je vse. Vse je tukaj in zdaj. Vsi prostori tega
                    vesolja so lahko tudi tukaj in zdaj, samo da imajo različno frekvenco.
                  </p>

                  <p className="mb-4">
                    Ko se bomo naučili izmeriti frekvenco točke A in frekvenco točke B — in nato predmetu (recimo avtu)
                    nastaviti drugo frekvenco — bo ta preprosto nehal obstajati tu in se bo pojavil tam. Evo, problem
                    logistike je rešen! 😎
                  </p>
            ...
            <ExpandableSection title="Mati Narava" summary="Mati Narava nas bo prijela za ušesa! 🌱👂" content={<>
                  ...
                  <p className="mb-4">
                    Ampak nekaj je kristalno jasno: Ko prideš danes domov, vprašaj svojega otroka, ki ga imaš kao
                    najraje: 👉 <strong>"Kakšen planet si želiš, da ti zapustim?"</strong>
                  </p>
            ...
            <ExpandableSection title="Gremo se tepst" summary="Ja nimamo kej, radi se tepemo :)" content={<>
                  ...
                  <p className="mb-4">
                    Počasi se bo treba zavedat: voditelji, ki niso razrešili vojne v sebi, jo prej ali slej projicirajo
                    navzven. To velja predvsem za tiste, ki stalno "branijo" svoj teritorij. Ko živiš v strahu, da ti bo
                    nekdo naredil nekaj hudega, se preventivno zaščitiš — in takoj označiš nekoga kot potencialnega
                    sovražnika. Ta oseba to zazna kot grožnjo, odgovori in potem spet ti — ping-pong, vojna je tu. Vsi
                    se samo branimo… in na koncu drug drugega napadamo.
                  </p>

                  <p className="mb-4">
                    V Novem Svetovnem Redu Lana imamo drugačen pristop: vojskujemo se z odprtim srcem. Verjamemo, da
                    razrešena notranja vojna vodi v preobrazbo zavesti v nekaj več. To ni za bleferje, šleve in tiste,
                    ki se radi zadržujejo v zameri — to je za pokončne, močne ljudi, ki so pripravljeni prevzeti
                    odgovornost in rasti.
                  </p>

                  <p>
                    Seveda — če pa kdo kljub vsemu verjame, da obstajajo realne grožnje, ima možnost predlagat
